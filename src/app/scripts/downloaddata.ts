...
export class DownloadExampleFiles {
  ...
  private data: { [key: string]: Object }[] = [
    {
      ...
      Location: "US",
      Phone: "(555) 111-1111",
      Email: "mariaanders@fakecompany.com",
      "Supervisor Name": "",
      "Supervisor ID": "",
      "Image URL": "./assets/dbstyle/orgchart_images/blank-male.jpg",
    },
    {
      Name: "Carine Schmitt",
      EmployeeID: "2",
      ...
      Location: "US",
      Phone: "(555) 222-2222",
      Email: "carineschmitt@fakecompany.com",
      "Supervisor Name": "Maria Anders",
      "Supervisor ID": "1",
      "Image URL": "./assets/dbstyle/orgchart_images/blank-male.jpg",
    },
    {
      ...
      Location: "US",
      Phone: "(555) 333-3333",
      Email: "danieltonini@fakecompany.com",
      "Supervisor Name": "Maria Anders",
      "Supervisor ID": "1",
      "Image URL": "./assets/dbstyle/orgchart_images/blank-male.jpg",
    },
    {
      ...
      Location: "US",
      Phone: "(555) 444-4444",
      Email: "alexcamino@fakecompany.com",
      "Supervisor Name": "Daniel Tonini",
      "Supervisor ID": "3",
      "Image URL": "./assets/dbstyle/orgchart_images/blank-male.jpg",
    },
    {
      ...
      Location: "US",
      Phone: "(555) 555-5555",
      Email: "jonesbergson@fakecompany.com",
      "Supervisor Name": "Daniel Tonini",
      "Supervisor ID": "3",
      "Image URL": "./assets/dbstyle/orgchart_images/blank-male.jpg",
    },
    {
      ...
      Location: "US",
      Phone: "(555) 666-6666",
      Email: "renephillips@fakecompany.com",
      "Supervisor Name": "Daniel Tonini",
      "Supervisor ID": "3",
      "Image URL": "./assets/dbstyle/orgchart_images/blank-male.jpg",
    },
  ...
  public downloadCSV(): void {
    let csv: string =
      "Name,EmployeeID,Role,Department,Location,Phone,Email,Supervisor Name,Supervisor ID,Image URL\n";
  ...
  public downloadJSON(): void {
    ...
    if ((window.navigator as any).msSaveBlob) {
      let blob: Blob = new Blob([dataStr], {
  ...
  public downloadFormatChange(args: ChangeArgs): void {
    if (args.event) {
      ...
      if (target.id === "csvFormat") {
        this.selectedItem.orgDataSettings.buttonContent =
          "Download Example CSV";
        this.selectedItem.orgDataSettings.extensionType = ".csv";
        (document.getElementById("descriptionText1") as any).innerHTML =
          "Make sure that each column of the table has a header";
        (document.getElementById("descriptionText2") as any).innerHTML =
          "Each employee should have a reporting person (except the top most employee of the organization)" +
        ...
        (document.getElementById("descriptionText1") as any).innerHTML =
          "Make sure that XML document has a unique root element and start-tags have matching end-tags.";
        (document.getElementById("descriptionText2") as any).innerHTML =
          "All XML elements will be considered employees and will act as a reporting person for its child XML elements.";
      } else {
        this.selectedItem.orgDataSettings.buttonContent =
          "Download Example JSON";
        this.selectedItem.orgDataSettings.extensionType = ".json";
        (document.getElementById("descriptionText1") as any).innerHTML =
          "Make sure that you have defined a valid JSON format.";
        (document.getElementById("descriptionText2") as any).innerHTML =
          "Each employee should have a reporting person (except the top most employee of the organization)" +
          ", and it should be indicated by any field from the data source.";
      }
