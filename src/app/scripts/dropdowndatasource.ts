...
export class DropDownDataSources {
  ...
  public gradientDirections: { [key: string]: any }[] = [
    { text: "BottomToTop", value: "BottomToTop" },
    { text: "TopToBottom", value: "TopToBottom" },
    { text: "RightToLeft", value: "RightToLeft" },
    { text: "LeftToRight", value: "LeftToRight" },
  ];
